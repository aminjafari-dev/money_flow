...
class GGap {
  ...
  /// )
  /// ```
  static Widget small() => const Gap(_sm);
  ...
  /// )
  /// ```
  static Widget medium() => const Gap(_md);
  ...
  /// )
  /// ```
  static Widget large() => const Gap(_lg);
  ...
  /// )
  /// ```
  static Widget extraLarge() => const Gap(_xl);
  ...
  /// )
  /// ```
  static Widget extraExtraLarge() => const Gap(_xxl);
  ...
  /// )
  /// ```
  static Widget extraSmall() => const Gap(_xs);
  ...
  /// )
  /// ```
  static Widget zero() => const Gap(0.0);
