...
class _$BankModelImpl implements _BankModel {
  const _$BankModelImpl(
      ...
      @HiveField(3) this.isActive = true,
  ...
  @override
  String toString() {
    return 'BankModel(id: $id, name: $name, phoneNumber: $phoneNumber, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, phoneNumber, isActive, createdAt, updatedAt);
...
abstract class _BankModel implements BankModel {
  const factory _BankModel(
      ...
      @HiveField(5) required final DateTime updatedAt}) = _$BankModelImpl;
